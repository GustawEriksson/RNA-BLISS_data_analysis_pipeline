...
# Description: Quality control of BLISS and sBLISS libraries using Pearson and Spearman
# correlation between bins of replicates. 
...
run_QC_BLISS <- function(BLISS_run, cell_type_vector = c("NES", "Progenitor", "Neuron"), 
  ...
  for (type in cell_type_vector) {
    ...
    for (window in windows) {
      ...
      run_QC = BLISS_BIN_QC(normalised_bin = normalised_bin, outdir = outdir_QC,
